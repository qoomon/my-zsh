...
alias http_server='command http-server -p 8080 -o'
# alias http_server='docker run --name my-nginx -p 80:80 -v $PWD:/usr/share/nginx/html:ro --rm nginx'
alias http_server_ssl="command http-server -p 8443 -o --ssl --cert $ZSH_FILE_DIR/localhost.pem --key $ZSH_FILE_DIR/localhost.pem"
alias https_server='http-server-ssl'
